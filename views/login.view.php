...
echo '<br>';
echo '<input type="text" name="email" class="mt-2 p-2 border border-gray-500 rounded w-full">';
echo '</div>';
echo '<div class="mb-4">';
echo '<label for="password" class="text-lg font-medium text-gray-700">Password:</label>';
echo '<br>';
echo '<input type="password" name="password" class="mt-2 p-2 border border-gray-300 rounded w-full">';
echo '</div>';
