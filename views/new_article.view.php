...
echo '<h2 class="text-xl text-center font-semibold text-indigo-700 mt-10 mb-10">Create Article</h2>';
...
echo '<input type="submit" value="Create" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">';
echo '</form>';
echo '</div>';
echo '</body>';
